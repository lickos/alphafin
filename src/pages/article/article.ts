...
export class ArticlePage {
  ...
  BadgeClass: any;
    ...
    constructor(public navCtrl: NavController,  private streamingMedia: StreamingMedia, public navParams: NavParams) {
  ...
  playVideo() {
    ...
    this.streamingMedia.playVideo('https://www.youtube.com/watch?v=AyS3uw7HZOM&t=347s', options);
  }
}
